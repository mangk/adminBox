...
func (s SysApi) SysApi() []SysApi {
	...
	return []SysApi{
		...
		{Model: Model{ID: -706}, MenuId: -200, Name: "移动文件", Description: "", Path: backendPrefix + "/sys/fileUpload/move", Method: "POST"},
		...
		{Model: Model{ID: -710}, MenuId: -200, Name: "文件上传(前端TOKEN授权直传-保存文件)", Description: "", Path: backendPrefix + "/sys/fileUpload/saveFileInfo", Method: "POST"},
		{Model: Model{ID: -711}, MenuId: -200, Name: "移动文件目录", Description: "", Path: backendPrefix + "/sys/fileGroup/move", Method: "POST"},
	}
}
