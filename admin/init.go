...
func DBMigrate() {
	...
	log.Infof("you can create with SQL: %s", "INSERT INTO `sys_auth` (`id`, `cb`, `ub`, `db`, `ct`, `ut`, `dt`, `table_id`, `table_module`, `type`, `key`, `set_value`) VALUES "+
		"(1, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-501', 1),"+
		"(2, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-702', 1),"+
		"(3, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-202', 1),"+
		"(4, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-300', 1),"+
		"(5, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-502', 1),"+
		"(6, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-604', 1),"+
		"(7, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-704', 1),"+
		"(8, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-104', 1),"+
		"(9, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'menu', '-302', 1),"+
		"(10, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-303', 1),"+
		"(11, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-403', 1),"+
		"(12, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-500', 1),"+
		"(13, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-503', 1),"+
		"(14, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-504', 1),"+
		"(15, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-703', 1),"+
		"(16, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'menu', '-301', 1),"+
		"(17, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'menu', '-303', 1),"+
		"(18, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-600', 1),"+
		"(19, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-603', 1),"+
		"(20, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-401', 1),"+
		"(21, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-601', 1),"+
		"(22, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-602', 1),"+
		"(23, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-201', 1),"+
		"(24, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-304', 1),"+
		"(25, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-400', 1),"+
		"(26, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-700', 1),"+
		"(27, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-102', 1),"+
		"(28, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-105', 1),"+
		"(29, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-203', 1),"+
		"(30, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-402', 1),"+
		"(31, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'menu', '-100', 1),"+
		"(32, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'menu', '-200', 1),"+
		"(33, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-405', 1),"+
		"(34, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-505', 1),"+
		"(35, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'menu', '-305', 1),"+
		"(36, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-101', 1),"+
		"(37, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-106', 1),"+
		"(38, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-200', 1),"+
		"(39, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'menu', '-306', 1),"+
		"(40, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-103', 1),"+
		"(41, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-204', 1),"+
		"(42, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'menu', '-304', 1),"+
		"(43, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-301', 1),"+
		"(44, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-302', 1),"+
		"(45, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-404', 1),"+
		"(46, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-701', 1),"+
		"(47, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'menu', '-300', 1),"+
		"(48, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'sys_role', 'api', '-100', 1),"+
