...
func (s SysMenu) SystemMenu() []SysMenu {
	return []SysMenu{
		s.welcomePage(),
		{Model: Model{ID: -200}, Pid: 0, Name: "fileManager", Path: "fileManager", Component: "views/file/manager.vue", Sort: -100, Meta: Meta{Title: "文件管理", KeepAlive: true, Icon: "upload-filled"}},
		{Model: Model{ID: -300}, Pid: 0, Name: "setting", Path: "setting", Component: "", Sort: -1000, Meta: Meta{Title: "系统设置", KeepAlive: true, Icon: "setting"}},
